...
if (isset($_POST['submit'])) {
	...
	if ($run) {
		$message =  $account == "Faollashtirish" ? "Hisob muvaffaqiyatli faollashtirildi" : "Hisob muvaffaqiyatli o'chirildi";
	}	
	else{
		$message = "Hisob muvaffaqiyatli faollashtirilmadi";
	}
}
?>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Foydalanuvchi hisobini boshqarish tizimi </h4>
				</div>
				<div class="row">
					<div class="container">
						<div class="row">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>Foydalanuvchi identifikatorini kiriting</label>
												<input type="text" name="user_id" class="form-control" required placeholder="Enter ID">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Hisob holatini kiriting:</label>
												<select name="account" class="form-control">
													<option>Hisob holatini tanlang</option>
													<option value="Activate">Faollashtirish</option>
													<option value="Deactivate">Faolsizlantirish</option>
