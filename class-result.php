...
?>
	...
	<!-- title of this page -->
		<title>Admin - Sinf natijasi</title>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Natijalarni boshqarish tizimi </h4>
					<a class="btn btn-outline-primary ml-auto mr-2 text-white" href="add-single-student-results.php">Yagona talaba natijasi</a>
				</div>
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-12">
