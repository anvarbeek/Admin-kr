...
<?php
	...
	if (isset($_POST['sub'])) {
		...
		for ($i=0; $i < $count; $i++) { 
			...
			if ($run) {
				$success_message = "Talabaga barcha fanlar muvaffaqiyatli topshirildi";
			}	
			else{
				$error_message = "Talabaga barcha fanlar muvaffaqiyatli topshirilmagan";
			}
		}
	}
...
?>
	...
	<!-- title of this page -->
		<title>Admin - Talabaga mavzuni belgilash</title>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="bar-margin text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<h4>Yagona talabaga mavzuni belgilash </h4>
				</div>
				<div class="row">
					<div class="col-md-12">
					<div class="col-md-12">
